    ...
    <div class="sidenav-menu">
        <div class="nav accordion" id="accordionSidenav">
            ...
            <a class="nav-link" href="tables.html">
                ...
                Dashboards <span class="badge bg-primary-soft text-primary ms-auto">Updated</span>
            </a>
            ...
            <div class="collapse" id="collapsePages" data-bs-parent="#accordionSidenav">
                <nav class="sidenav-menu-nested nav accordion" id="accordionSidenavPagesMenu">
                    <a class="nav-link" href="pricing.html">Pegawai</a>
                    <a class="nav-link" href="pricing.html">Departemen</a>
                    <a class="nav-link" href="pricing.html">Tim</a>
                    <a class="nav-link" href="pricing.html">Hari Libur Nasional</a>
                    <a class="nav-link" href="pricing.html">Referensi Jenis</a>
            ...
            <!-- Sidenav Heading (Pengaturan)-->
            <div class="sidenav-menu-heading">Pengaturan</div>
            <a class="nav-link collapsed" href="javascript:void(0);" data-bs-toggle="collapse" data-bs-target="#collapseSistem" aria-expanded="false" aria-controls="collapseLayouts">
                <div class="nav-link-icon"><i data-feather="tool"></i></div>
                Sistem
                <div class="sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
            </a>
            <div class="collapse" id="collapseSistem" data-bs-parent="#accordionSidenav">
                <nav class="sidenav-menu-nested nav accordion" id="accordionSidenavLayout">
                    <a class="nav-link" href="pricing.html">User</a>
                    <a class="nav-link" href="pricing.html">Roles</a>
                    <a class="nav-link" href="pricing.html">Setting</a>
                </nav>
            </div>
